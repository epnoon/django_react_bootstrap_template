  ...
  if (confirmation.can_confirm) {
    body = (
      <>
        <p>
          Please confirm that{" "}
          <a href={"mailto:" + confirmation.email}>{confirmation.email}</a> is
          an email address for user {confirmation.user.display}.
        </p>
    ...
    body = (
      <p>
        ...
        <a href={"mailto:" + confirmation.email}>{confirmation.email}</a>{" "}
